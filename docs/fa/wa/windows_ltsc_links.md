...
> - [سوالات متداول](./genuine-installation-media#faq)
...
::: details برای اطلاعات اینجا کلیک کنید
...
> - پاورشل را به عنوان مدیر باز کرده و وارد کنید:
>
> ```reg
> wsreset -i
> ```
...
| **Edge غیرقابل حذف خارج از EEA** | بله | خیر |
...
> - ISOهایی برای IoT Enterprise LTSC/LTSB 2019, 2016 و 2015 موجود است، اما آنها فقط کلید OEM LTSC غیر IoT (عمومی، فعال نشده) را از پیش نصب کرده‌اند. کلید نصب شده تنها تفاوت است. نسخه واقعی و متفاوتی از IoT برای این نسخه‌ها موجود نیست.
...
>
> - به طور جایگزین، می‌توانید Non-IoT LTSC را به زبان دیگری نصب کرده و بعداً کلید IoT LTSC 2024 `KBN8V-HFGQ4-MGXVD-347P6-PDQGT` را در صفحه فعال‌سازی در تنظیمات ویندوز برای تغییر نسخه نصب کنید.
...
ISOهای نسخه IoT LTSC فقط به زبان انگلیسی موجود هستند.
