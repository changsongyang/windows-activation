...
- دسترسی ادمین <Badge type="danger" text="Administrator" /> برای <Badge type="danger" text="CMD" /> در کامپیوتر
- اتصال به <Badge type="tip" text="VPN" /> درصورت اجرا نشدن فرامین (دامنه‌ها فعلاً فیلتر نشده‌اند پس طبیعتاً برای اجرای دستورها نیازی به اتصال <Badge type="tip" text="VPN" /> نیست)
...
4. اگر پنجره User Account Control ظاهر شد، روی `Yes` کلیک کنید <br/>

<p align="center">
  <img src="https://github.com/user-attachments/assets/4465a2d3-6c93-4ee1-bb63-94ab7b8e06ac" alt="run-cmd-as-admin" width="480px" />
</p>
...
[^8]: برای بررسی وضعیت فعال‌سازی ویندوز 11، به مسیر: <br/>  
Settings → System → Activation <br/>بروید. وضعیت فعال‌سازی نمایش داده می‌شود و نشان می‌دهد که آیا ویندوز فعال است یا خیر، همراه با جزئیات روش فعال‌سازی و هر حساب مایکروسافت پیوند شده.
