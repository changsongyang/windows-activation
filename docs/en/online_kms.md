...
```
-   This is perfectly fine to keep, and it does not affect Windows or Office activation. For more explanation, visit [Office license is not genuine](./en/office-license-is-not-genuine).
...
-   Check [Command line switches](./en/command_line_switches).
